...
- **Citation-count floor** — `citationCount` under 3 (allow 0-2 for papers under 18 months old) cannot serve as the sole corroborating source lifting a claim to HIGH confidence.
